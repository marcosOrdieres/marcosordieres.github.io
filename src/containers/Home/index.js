        ...
        <div className="secondPart">
          <div className="firstCol">
            <div className="titleText">
              <h2 className="secondPartText">Work</h2>
            </div>
            <div className="subtitleText">
              <h2 className="secondPartText">As a Software Developer based in Berlin, I am able to produce high quality responsive applications and websites with a exceptional user experience</h2>
            </div>
          </div>
